...
"""
MEMO: This simulation checks the stability of resistance on phages and plasmids while influxing all types of bacteria and evolving lysis, lysogenization, and conjugation
"""
...
def main():
    base_dir = '/nesi/nobackup/uoa04131/data/PhageModel/PhageModel55_1/'

    command = """#!/bin/bash -e

#SBATCH --job-name=451_{pops:}_{count:}      # job name (shows up in the queue)
